...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_drawing_subvol_no = QtWidgets.QLineEdit(Dialog)
        ...
        self.lineEdit_drawing_name = QtWidgets.QLineEdit(Dialog)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_subvol_no.setText(_translate("Dialog", "本次出版的分册号"))
